#ifndef DEVICEARDUINOADAPTER_H
#define DEVICEARDUINOADAPTER_H
...
public:
    DeviceControllerState(size_t sensorsPackageSize = 2, size_t devicesPackageSize = 3)
    {
...
class ArduinoDeviceAdapter : public QObject
{
    Q_OBJECT
public:
    explicit ArduinoDeviceAdapter(QString portName, QObject *parent = nullptr);
...
protected:
    ...
    DeviceControllerState *m_currentState;
    DeviceControllerState *m_previousState;
...
protected slots:
    ...
    void sendStateToServer(DeviceControllerState *state);

    void sendTestPackageToServer();
};

#endif // DEVICEARDUINOADAPTER_H
