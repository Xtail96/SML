...
/*!
 * \brief Класс "Точка"
 * \brief Данный класс содержит данные о координатах точки по каждой из существуюущих осей станка.
 *
 * Способы взаимодействия с классом:
 * 1) Добавление точки;
 * 2) Получение значений координаты точки по оси по имени оси;
 * 3) Осуществление взаимодействия(получени/установка) с координатами точки;
 */
struct Point{
