...
typedef struct setup_struct {
    ...
    // codes
    double active_settings[RS274NGC_ACTIVE_SETTINGS];	// array of feed,
    // speed, etc.
	...
	// the interpreter keeps track of which variables change each line

    double parameters[RS274NGC_MAX_PARAMETERS];	// system parameters

	// below this point are things that don't need to persist line to line
